...
async function migrate() {
    ...
    try {
        ...
        const keys = [
            { provider: 'openai', name: 'Principal', key: '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', priority: 1 },
            { provider: 'openai', name: 'Redundante', key: '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', priority: 2 },
            { provider: 'kie', name: 'Fluxo Extra', key: '26cda1f14cae98401c5915e892999068', priority: 3 }
        ];
        for (const k of keys) {
            await query(`
