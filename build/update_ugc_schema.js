...

{
  "video_prompt": {
    ...
    try {
        await query('UPDATE prompt_agents SET system_prompt = $1, updated_at = now() WHERE technical_id = $2 OR technical_id = $3', [newPrompt, 'ugc-influencer-video', 'ugc-realistic']);
